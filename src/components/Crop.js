...
class Crop extends Component {
  ...
  state = {
    inputVal: this.props.coordinate&&this.props.coordinate.inputVal||''
  }

  handleSave = () => {
    const { coordinate, coordinate: { x, y },coordinates, index, onSave } = this.props
    const nextCoordinate = { ...coordinate, x: x, y: y, inputVal: this.state.inputVal }
    const nextCoordinates = update(index, nextCoordinate)(coordinates)
  ...
  render() {
    const { coordinate, index, onSave } = this.props
    return (
      <div
